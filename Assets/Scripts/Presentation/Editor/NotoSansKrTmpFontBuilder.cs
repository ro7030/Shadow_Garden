    ...
    public static class NotoSansKrTmpFontBuilder
    {
        ...
        public static string BuildCorpus()
        {
            ...
            string[] phrases =
            {
                ...
                "다시 도전", "레벨 선택", "목표", "출구 문", "밤꽃", "BEST", "NEW",
                ...
                "정원으로 돌아가기", "타이틀로 돌아가기", "새로 시작", "마지막", "완료",
                ...
                "클릭하여 복귀",
                "일시정지", "계속하기", "설정", "효과음", "배경음", "모션 완화", "점멸 맥동 제거",
                "오프닝 다시 보기", "저장 후 오프닝 다시 보기", "닫기", "저장", "전체화면", "조작 확인",
                "태양등 회전", "메뉴", "일시정지는 화면 버튼", "일시정지는 Esc·화면 버튼",
                "빛과 그림자로 잠든 정원을 되살린다",
                ...
                "정원으로", "다음", "건너뛰기", "오프닝", "정원이 숨을 고른다",
                "세 정원이 모두 되살아났습니다", "다음 월드가 해금되었습니다",
                "출구 완료", "밤꽃 완료", "남은 시간",
                "출구로 나가기", "밤꽃에 도달하기", "곧 어둠이 닥쳐옵니다", "WORLD",
